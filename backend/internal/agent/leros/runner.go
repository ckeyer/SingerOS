...
import (
	...
	"github.com/insmtx/Leros/backend/internal/agent/environment"
...
func NewRunner(ctx context.Context, llmConfig *config.LLMConfig, env *environment.Environment) (*Runner, error) {
	if llmConfig == nil {
